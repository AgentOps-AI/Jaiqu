...
from jaiqu import openai_client
...
You come to a definitive conclusion, the name of the key you found, at the end of your response."""
    ...
    reasoning_response = openai_client.chat.completions.create(messages=messages,
                                                        model="gpt-4",
...
"""
    ...
    response = openai_client.chat.completions.create(messages=messages, model="gpt-4-0125-preview")
